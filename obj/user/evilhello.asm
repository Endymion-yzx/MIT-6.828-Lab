...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  8009f9:	83 ec 0c             	sub    $0xc,%esp
	...
	panic("devfile_write not implemented");
  8009fc:	68 04 1f 80 00       	push   $0x801f04
  800a01:	68 90 00 00 00       	push   $0x90
  800a06:	68 22 1f 80 00       	push   $0x801f22
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a42:	68 2d 1f 80 00       	push   $0x801f2d
  800a47:	68 34 1f 80 00       	push   $0x801f34
  800a4c:	6a 7c                	push   $0x7c
  800a4e:	68 22 1f 80 00       	push   $0x801f22
  800a53:	e8 bd 05 00 00       	call   801015 <_panic>
	assert(r <= PGSIZE);
  800a58:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a5d:	7e 16                	jle    800a75 <devfile_read+0x65>
  800a5f:	68 49 1f 80 00       	push   $0x801f49
  800a64:	68 34 1f 80 00       	push   $0x801f34
  800a69:	6a 7d                	push   $0x7d
  800a6b:	68 22 1f 80 00       	push   $0x801f22
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b4e:	68 55 1f 80 00       	push   $0x801f55
  800b53:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bfe:	50                   	push   %eax
  800bff:	56                   	push   %esi
  800c00:	68 5c 1f 80 00       	push   $0x801f5c
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800ea2:	68 74 1f 80 00       	push   $0x801f74
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801031:	56                   	push   %esi
  801032:	50                   	push   %eax
  801033:	68 80 1f 80 00       	push   $0x801f80
  ...
  801044:	e8 54 00 00 00       	call   80109d <vcprintf>
	cprintf("\n");
  801049:	c7 04 24 6d 1f 80 00 	movl   $0x801f6d,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80119c:	0f be 80 a3 1f 80 00 	movsbl 0x801fa3(%eax),%eax
  8011a3:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801330:	50                   	push   %eax
  801331:	68 bb 1f 80 00       	push   $0x801fbb
  801336:	53                   	push   %ebx
  801337:	56                   	push   %esi
  ...
  80134b:	52                   	push   %edx
  80134c:	68 46 1f 80 00       	push   $0x801f46
  801351:	53                   	push   %ebx
  801352:	56                   	push   %esi
  ...
  801376:	b8 b4 1f 80 00       	mov    $0x801fb4,%eax
