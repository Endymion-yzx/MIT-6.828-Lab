...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80039e:	52                   	push   %edx
  80039f:	68 7a 22 80 00       	push   $0x80227a
  8003a4:	53                   	push   %ebx
  8003a5:	56                   	push   %esi
...
sys_env_destroy(envid_t envid)
{
  ...
  800b19:	68 7f 21 80 00       	push   $0x80217f
  800b1e:	6a 23                	push   $0x23
  800b20:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800b9a:	68 7f 21 80 00       	push   $0x80217f
  800b9f:	6a 23                	push   $0x23
  800ba1:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800bdc:	68 7f 21 80 00       	push   $0x80217f
  800be1:	6a 23                	push   $0x23
  800be3:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c1e:	68 7f 21 80 00       	push   $0x80217f
  800c23:	6a 23                	push   $0x23
  800c25:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c60:	68 7f 21 80 00       	push   $0x80217f
  800c65:	6a 23                	push   $0x23
  800c67:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800ca2:	68 7f 21 80 00       	push   $0x80217f
  800ca7:	6a 23                	push   $0x23
  800ca9:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800ce4:	68 7f 21 80 00       	push   $0x80217f
  800ce9:	6a 23                	push   $0x23
  800ceb:	68 9c 21 80 00       	push   $0x80219c
...
sys_ipc_recv(void *dstva)
{
  ...
  800d48:	68 7f 21 80 00       	push   $0x80217f
  800d4d:	6a 23                	push   $0x23
  800d4f:	68 9c 21 80 00       	push   $0x80219c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e36:	ba 28 22 80 00       	mov    $0x802228,%edx
	int i;
	for (i = 0; devtab[i]; i++)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e61:	51                   	push   %ecx
  800e62:	50                   	push   %eax
  800e63:	68 ac 21 80 00       	push   $0x8021ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  80108b:	53                   	push   %ebx
  80108c:	50                   	push   %eax
  80108d:	68 ed 21 80 00       	push   $0x8021ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  801160:	53                   	push   %ebx
  801161:	50                   	push   %eax
  801162:	68 09 22 80 00       	push   $0x802209
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801215:	53                   	push   %ebx
  801216:	50                   	push   %eax
  801217:	68 cc 21 80 00       	push   $0x8021cc
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801403:	83 ec 0c             	sub    $0xc,%esp
	...
	panic("devfile_write not implemented");
  801406:	68 38 22 80 00       	push   $0x802238
  80140b:	68 90 00 00 00       	push   $0x90
  801410:	68 56 22 80 00       	push   $0x802256
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80144c:	68 61 22 80 00       	push   $0x802261
  801451:	68 68 22 80 00       	push   $0x802268
  801456:	6a 7c                	push   $0x7c
  801458:	68 56 22 80 00       	push   $0x802256
  80145d:	e8 bd 05 00 00       	call   801a1f <_panic>
	assert(r <= PGSIZE);
  801462:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801467:	7e 16                	jle    80147f <devfile_read+0x65>
  801469:	68 7d 22 80 00       	push   $0x80227d
  80146e:	68 68 22 80 00       	push   $0x802268
  801473:	6a 7d                	push   $0x7d
  801475:	68 56 22 80 00       	push   $0x802256
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801558:	68 89 22 80 00       	push   $0x802289
  80155d:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  801608:	50                   	push   %eax
  801609:	56                   	push   %esi
  80160a:	68 90 22 80 00       	push   $0x802290
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018ac:	68 a8 22 80 00       	push   $0x8022a8
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a3b:	56                   	push   %esi
  801a3c:	50                   	push   %eax
  801a3d:	68 b4 22 80 00       	push   $0x8022b4
  ...
  801a4e:	e8 9d e6 ff ff       	call   8000f0 <vcprintf>
	cprintf("\n");
  801a53:	c7 04 24 a1 22 80 00 	movl   $0x8022a1,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b0d:	50                   	push   %eax
  801b0e:	68 d8 22 80 00       	push   $0x8022d8
  801b13:	6a 39                	push   $0x39
  801b15:	68 e5 22 80 00       	push   $0x8022e5
